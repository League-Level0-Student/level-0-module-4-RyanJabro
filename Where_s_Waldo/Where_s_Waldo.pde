void setup() {
      PImage waldo = loadImage("maxresdefault.jpg"); // 5. Change this to match your file name.
      size(1400, 1400);
      image(waldo, 0, 0);
...
println("X : " + mouseX + " Y: " + mouseY);
if(mousePressed) {     // 7. If the mouse is on Waldo, print “Waldo found!”
if(mouseX > 1254 && mouseY > 79 && 1289 > mouseX && 112 > mouseY) {
println("Waldo found");
playWoohoo();
}
else {
